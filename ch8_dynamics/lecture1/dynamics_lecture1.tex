...
\newcommand{\sectiontitleI}{Introductory to Dynamics} % More Titles and Stuff
...
\frame{
	...
	\end{itemize}
    \includegraphics[scale=.25]{spotmini_cropped.png}
	\end{multicols}	
	\small Also in Ch. 8
...
\[ \frac{d}{dt}|r_{pq}|^2=\frac{d}{dt}(\vec{r}_{pq}\cdotp\vec{r}_{pq})=2\vec{r}_{pq}\cdotp\frac{d\vec{r}_{pq}}{dt}=0 \]
...
\frame{
  \frametitle{\sectiontitleIV}
		...
		\includegraphics[scale=0.8]{example_8_8.png}
